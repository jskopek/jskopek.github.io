...
for expected_folder in ['large', 'medium', 'small']:
...
for filename in filenames:
    ...
    print(f'{{% include photo.html alt="{filename}" path="{small_path}/{filename}" medium_path="{medium_path}/{filename}" large_path="{large_path}/{filename}" width={width} height={height} %}}')
